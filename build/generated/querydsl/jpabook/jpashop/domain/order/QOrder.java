...
public class QOrder extends EntityPathBase<Order> {
    ...
    public final jpabook.jpashop.domain.QDelivery delivery;
    ...
    public QOrder(Class<? extends Order> type, PathMetadata metadata, PathInits inits) {
        ...
        this.delivery = inits.isInitialized("delivery") ? new jpabook.jpashop.domain.QDelivery(forProperty("delivery"), inits.get("delivery")) : null;
