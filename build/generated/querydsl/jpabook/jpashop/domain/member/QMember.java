...
public class QMember extends EntityPathBase<Member> {
    ...
    public final ListPath<jpabook.jpashop.domain.cart.CartItem, jpabook.jpashop.domain.cart.QCartItem> cartItems = this.<jpabook.jpashop.domain.cart.CartItem, jpabook.jpashop.domain.cart.QCartItem>createList("cartItems", jpabook.jpashop.domain.cart.CartItem.class, jpabook.jpashop.domain.cart.QCartItem.class, PathInits.DIRECT2);
